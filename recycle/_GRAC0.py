...
from cellcloud3d.alignment._neighbors  import trip_edges
...
class GRAC():
    ...
    # @staticmethod
    # def psnnpairs(hData, mnn_idx):
    #     from cellcloud3d.integration._SNN import SNNDPC
    #     print(mnn_idx.shape)
    #     _, label = SNNDPC(5, 30, hData)
    #     label_s= label[mnn_idx[0].numpy()]
    #     label_r= label[mnn_idx[1].numpy()]
    #     cidx = label_r== label_s
    #     print(cidx.sum())
