...
'''
***********************************************************
* @File    : _highly_variable_genes.py
* @Author  : Wei Zhou                                     *
* @Date    : 2023/12/03 20:16:36                          *
...
from scanpy._utils import sanitize_anndata, check_nonnegative_integers
...
## coding from scanpy. Just get more information from the code
